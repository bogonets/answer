...
export default class ApiV2 extends ReccApi {
  ...
  deleteVmsDeviceRtcJsep(group: string, project: string, device: string, peer: string) {
  ...
  getVmsDeviceEventsConfigs(group: string, project: string, device: string) {
  ...
  postVmsDiscovery(group: string, project: string, body: VmsDiscoveryQ) {
  ...
  postVmsOnvifMedia(group: string, project: string, body: VmsOnvifMediaStreamUriQ) {
  ...
  getVmsRecordsPdeviceDates(group: string, project: string, device: string) {
