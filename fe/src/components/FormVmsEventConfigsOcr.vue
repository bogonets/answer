            ...
            >
              ...
              >
                <template v-slot:activator="{on, attrs}">
                  <v-btn v-show="n >= 2" class="mr-2" rounded v-bind="attrs" v-on="on">
              ...
              >
                <template v-slot:activator="{on, attrs}">
                  <v-btn class="mr-2" rounded v-bind="attrs" v-on="on">
...
export default class FormVmsEventConfigsOcr extends VueBase {
  ...
  requestEventOcr() {
    ...
    this.loading = true;
    this.$api2
      .postVmsDeviceProcessDebugEventOcr(group, project, device, this.value)
      .then(() => {
        this.loading = false;
      })
      .catch(error => {
