...
import AdminVmsDevicesEdit from '@/pages/admin/AdminVmsDevicesEdit.vue';
...
export const adminChildren = [
    ...
    {
        path: 'vms/devices/edit/:device',
        component: AdminVmsDevicesEdit,
        name: adminNames.adminVmsDevicesEdit,
    },
    {
