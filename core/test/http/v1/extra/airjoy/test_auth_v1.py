...
class AirjoyV1TestAuthCase(AsyncTestCase):
    ...
    async def test_airjoy(self):
        ...
        project_ids_get = await self.tester.get_request(
        ...
        project_members_get = await self.tester.get_request(
        ...
        project_member_add = await self.tester.post_request(
        ...
        project_member_auth_edit = await self.tester.post_request(
        ...
        project_member_delete = await self.tester.post_request(
