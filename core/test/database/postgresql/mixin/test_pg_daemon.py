...
class PgDaemonTestCase(PostgresqlTestCase):
    async def test_create_and_get(self):
        ...
        uid1 = await self.db.insert_daemon(
            plugin1, slug1, name1, address1, requirements1, created_at=created_at1
        )
        uid2 = await self.db.insert_daemon(
            plugin2, slug2, name2, address2, requirements2, created_at=created_at2
        )
    ...
    async def test_update(self):
        ...
        self.assertIsNone(daemon2.name)
