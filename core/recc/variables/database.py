...
TABLE_PIP = f"{TABLE_PREFIX}pip"
TABLE_USER_INFO = f"{TABLE_PREFIX}user_info"
...
FUNC_ADD_DAEMON_AND_PORT = f"{FUNC_PREFIX}add_daemon_and_port"
...
USER_INFO_KEY_STR_SIZE = 256
USER_INFO_VALUE_STR_SIZE = 2048
LANG_STR_SIZE = 4  # https://en.wikipedia.org/wiki/List_of_ISO_639-1_codes
TIMEZONE_STR_SIZE = 32  # https://en.wikipedia.org/wiki/List_of_tz_database_time_zones
PASSWORD_BYTE = 32
...
REFERENCE_CATEGORY_RECC_DAEMON = "recc.daemon"
REFERENCE_CATEGORY_VMS_SERVER = "vms.server"

PIP_DOMAIN_RECC = "recc"
PIP_HASH_METHOD_SHA256 = "sha256"
