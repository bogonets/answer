...
VIEW_UNION_MEMBER = f"{VIEW_PREFIX}union_member"
...
UNION_MEMBER_CATEGORY_GROUP = 0
UNION_MEMBER_CATEGORY_PROJECT = 1
...
PERMISSION_SLUG_RECC_DOMAIN_STORAGE_VIEW = "recc.domain.storage.view"
PERMISSION_SLUG_RECC_DOMAIN_STORAGE_EDIT = "recc.domain.storage.edit"
PERMISSION_SLUG_RECC_DOMAIN_MANAGER_VIEW = "recc.domain.manager.view"
PERMISSION_SLUG_RECC_DOMAIN_MANAGER_EDIT = "recc.domain.manager.edit"
PERMISSION_SLUG_RECC_DOMAIN_GRAPH_VIEW = "recc.domain.graph.view"
PERMISSION_SLUG_RECC_DOMAIN_GRAPH_EDIT = "recc.domain.graph.edit"
