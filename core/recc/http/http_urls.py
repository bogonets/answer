...
raw_rule_pgroup = raw + rule + pgroup
raw_rule_pgroup_pproject = raw_rule_pgroup + pproject
rules_prule = rules + prule
rules_pgroup = rules + pgroup
rules_pgroup_pproject = rules + pgroup + pproject
