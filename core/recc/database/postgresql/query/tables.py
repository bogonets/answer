...
CREATE TABLE IF NOT EXISTS {TABLE_RULE} (
    ...
    slug VARCHAR({RULE_SLUG_STR_SIZE}) UNIQUE NOT NULL,
    name VARCHAR({RULE_NAME_STR_SIZE}),
    description TEXT,
    features VARCHAR({FEATURE_NAME_STR_SIZE})[],
    extra JSONB,
...
DROP_TABLE_PERMISSION = f"DROP TABLE IF EXISTS {TABLE_RULE};"
